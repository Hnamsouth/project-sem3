                ...
                <table className="table table-wishlist table-mobile">
                    ...
                    <tr>
                        ...
                        <div className="dropdown">
                            ...
                            <i className="icon-list-alt" />Select Options
                            </button>
                    ...
                    <tr>
                        ...
                        <div className="product">
                            <figure className="product-media">
                            <a href="#">
                                <img src="/user/assets/images/products/table/product-2.jpg" alt="Product image" />
                            </a>
                            </figure>
                            <h3 className="product-title">
                    ...
                    <tr>
                        ...
                        <div className="product">
                            <figure className="product-media">
                            <a href="#">
                                <img src="/user/assets/images/products/table/product-3.jpg" alt="Product image" />
                            </a>
                            </figure>
                            <h3 className="product-title">
