            ...
            <div className="page-content">
                ...
                <div className="product-details-tab">
                    <Tabs
                        ...
                        variant='pills'
                    >
                        <Tab eventKey="des" title="Description" className="fade">
                        ...
                        <Tab eventKey="info" title="Additional information" className="fade">
                            <div className="product-desc-content">
                                <h3>Information</h3>
                        ...
                        <Tab eventKey="shipping" title="Shipping &amp; Returns"  className="fade">
                            <div className="product-desc-content">
                        ...
                        <Tab eventKey="review" title="Reviews (2)"  className="fade">
